package code.exercise.twojugs.impl.arithmetic;
...
/**
 * Arithmetic Approach Algorithm implementation for solving two jug problem.
 * @author Saida Dhanavath
 *
 */
public class ArithmeticTwoJugProblem extends AbstractTwoJugProblem {

	@Override
	public TwoJugResult getSolution(int sizeOfJugM, int sizeOfJugN,
			int sizeOfSolution) throws TwoJugException {
		// TODO: SOLUTION IS IN-PROGRESS
		return null;
	}
